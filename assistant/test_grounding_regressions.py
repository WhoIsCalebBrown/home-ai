...
library_count_category = namespace["library_count_category"]
...
def test_operation_for_plan_uses_existing_media_vocabulary_and_bounded_scopes():
    ...
    operation, scope = operation_for_plan("How many films are in my library?", {}, [("plex_library_counts", {})])
    assert operation == "PLEX_LIBRARY_COUNT"
    assert scope == {"category": "movie"}

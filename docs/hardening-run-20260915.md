...
- Isolated qualification lane now has 100 passing tests, including 140 acquisition-language mutations, side-effect tripwires, cross-session confirmation rejection, expiry, provider failure, exact episode fail-closed behavior, restart persistence, and canonical-ID collision checks.
